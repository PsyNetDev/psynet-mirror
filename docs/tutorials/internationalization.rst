...
- the script the language should be written in, from CLDR (e.g. Ol Chiki for Santali), except where PsyNet's
  catalogs use another script (Arabic for Kurdish, Latin for Serbian).
