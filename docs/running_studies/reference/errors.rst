...
Slack notifications
--------------------
We strongly recommended setting up the :doc:`Slack integration </running_studies/reference/setting_up_slack>` to receive error notifications in your Slack channel.
