...
:doc:`example PsyNet experiments </examples/example_experiments/index>`
...
website's search box, or to look it up in the :doc:`API documentation </reference/api/index>` section.
